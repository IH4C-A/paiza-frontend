...
const problems = [
  {
    ...
    detail: "Reactを使用して再利用可能なコンポーネントを設計する問題。状態管理とpropsの適切な使用方法を学びます。",
  ...
  },
  {
    title: "二分探索木の実装",
    description: "アルゴリズム",
    detail: "二分探索木のデータ構造を実装し、挿入、検索、削除の操作を実装する問題。効率的なデータ構造の理解を深めます。",
    tags: ["データ構造", "二分木", "探索"],
    rank: "B",
    rankColor: "#facc15"
  },
  ...
  },
  {
    title: "データベース正規化",
    description: "情報処理試験",
    detail: "データベース設計における正規化の概念と実践方法を学ぶ問題。第1正規形から第3正規形までの変換を行います。",
    tags: ["データベース", "正規化", "SQL"],
    rank: "A",
    rankColor: "#f97316"
  },
  {
    title: "GraphQLスキーマ設計",
    description: "Webフレームワーク",
    detail: "GraphQLのスキーマ設計とリゾルバの実装を行う問題。RESTful APIとの違いと利点を理解します。",
  ...
  },
  {
    title: "ダイクストラ法の実装",
    description: "アルゴリズム",
    detail: "グラフ上の最短経路を求めるダイクストラ法を実装する問題。優先度キューを使った効率的な実装方法を学びます。",
          ...
          <div className={styles.pageHeader}>
            ...
            <div className={styles.searchFilterWrapper}>
              <div className={styles.searchBox}>
                ...
                <input type="search" placeholder="問題を検索..." className={styles.searchInput} />
              </div>
